...
const CONTACT_CARDS = [
  ...
  },
  {
    ...
    iconType: 'svg',
    icon: (
      <svg aria-hidden="true" className="w-6 h-6" viewBox="0 0 24 24" style={{ fill: '#a78bfa' }}>
  ...
  },
  {
    ...
    iconType: 'svg',
    icon: (
      <svg aria-hidden="true" className="w-5 h-5" viewBox="0 0 24 24" style={{ fill: '#a78bfa' }}>
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative w-full">
      ...
      <div className="relative z-10 w-full max-w-container-max mx-auto px-6 md:px-margin-desktop py-section-gap flex flex-col items-center">
        ...
        >
          {CONTACT_CARDS.map((card) => (
            <motion.a
              ...
              whileHover={{ y: -5, boxShadow: '0 0 20px rgba(124,58,237,0.15)' }}
            ...
            >
              ...
              >
                {card.iconType === 'material' ? (
                  <span className="material-symbols-outlined" style={{ color: '#a78bfa', fontVariationSettings: "'FILL' 0" }}>
                    {card.icon}
                  </span>
                ) : (
                  card.icon
